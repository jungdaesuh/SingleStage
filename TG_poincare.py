...
OUT_DIR = '/Users/tianlanggong/simsopt/examples/outputs/stage2_initial_conditions/wout_nfp22ginsburg_000_001242/06_ntf4_diprad_0.05_VVa_0.26_VVb_0.27_VV_R0_1.03/'
...
def trace_fieldlines(bfield, label):
    ...
    #TG:
    R0 = np.linspace(np.min(R), np.max(R), nfieldlines)
    Z0 = np.zeros(nfieldlines)
