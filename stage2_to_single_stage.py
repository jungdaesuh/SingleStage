...
print(f"Surface resolution: mpol={surface.mpol}, ntor={surface.ntor}")
...
NONQS_WEIGHT = 1.0
IOTAS_WEIGHT = 1.0 # 1e-1,2
CURRS_WEIGHT = 1.0 # 1e2
BZRES_WEIGHT = 1. # 1e-1
# TG see if the single stage succeeds
...
output_dir = "/burg-archive/home/tg2998/simsopt/examples/outputs/TG_single_stage_outputs_positiveG"
savefile = os.path.join(output_dir, f"optimized_boozer_surface_{TF_a_cur:.3f}.json")
